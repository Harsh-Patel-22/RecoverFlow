...
import { Play, Activity, ShieldCheck, RefreshCw } from "lucide-react";
...
export default function Navbar({ onBatchRunComplete }: { onBatchRunComplete?: () => void }) {
  ...
  return (
    <header className="bg-[#07162C] border-b border-slate-800 text-white sticky top-0 z-50 shadow-md">
